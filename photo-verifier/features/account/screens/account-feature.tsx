...
import { AccountUiTokenAccounts } from '@/features/account/ui/account-ui-token-accounts'
import { RefreshControl, ScrollView } from 'react-native'
import { useCallback, useState } from 'react'
import { useGetBalanceInvalidate } from '@/features/account/hooks/use-get-balance'
import { PublicKey } from '@solana/web3.js'
import { useGetTokenAccountsInvalidate } from '@/features/account/hooks/use-get-token-accounts'
import { WalletUiButtonConnect } from '@/components/solana/ui/wallet-ui-button-connect'
